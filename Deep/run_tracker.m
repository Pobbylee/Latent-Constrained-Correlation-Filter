...
%             padding, lambda, output_sigma_factor, ...
%             interp_factor,cell_size, show_visualization);
         [positions, time] = tracker_lccf_deep(video_path, img_files, pos, target_sz, ...
            padding, lambda, output_sigma_factor, ...
...
%          save(strcat('.\results-CF2\',video,'_CF2.mat'),'results');
%         save(strcat('.\results-LCKCF_DEEP\',video,'_LCKCF_DEEP.mat'),'results');
end
end
